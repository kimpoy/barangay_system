...
<div class="container">
    ...
    <div class="row justify-content-center">
        <div class="d-flex justify-content-between w-100">
            <button type="submit" class="btn btn-primary mt-3 mb-1 createbtn" name="create">Create new account</button>
            <input class="form-control mt-3 mb-1 w-25" id="user-search" type="text" placeholder="Search..">
        </div>
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                ...
                                <a href="user.php?deleteUser=<?php echo $row['id']; ?>" class="btn btn-danger">Delete</a>
                            </td>
                        </tr>
                    <?php endif ?>
                <?php endwhile; ?>
