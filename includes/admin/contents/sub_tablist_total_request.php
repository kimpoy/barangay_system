<div class="list-group list-group-horizontal" id="myList" role="tablist">
    <a class="list-group-item list-group-item-action" id="list-all-list" data-toggle="list" href="#list-all" role="tab" aria-controls="all">Total</a>
    <a class="list-group-item list-group-item-action" id="list-week-list" data-toggle="list" href="#list-week" role="tab" aria-controls="week">Week</a>
