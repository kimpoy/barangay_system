        ...
        <div class="content-wrapper">
            ...
            <div class="right-content">
                ...
                <p class="indention">This is to certify that <input class="field-form" type="text" value="<?php echo $_GET['fullname']; ?>" readonly>
                    is a bonafide resident of this barangay. This is to certify further that he/she is a <input class="field-form" type="text" value="<?php echo $_GET['work']; ?>" readonly>
                    and doesn’t have a fix income. That base from our records, their family is considered one of the indigents of this barangay.</p>
                <p class="indention">This certification is being issued this <input class="field-form" type="text" value="<?php echo date("jS"); ?>" readonly>
                    day of <input class="field-form" type="text" value="<?php echo date("F"); ?>" readonly>, 2021 upon the request of Mr./Ms./Mrs.<input class="field-form" type="text" value="<?php echo $_GET['fullname']; ?>" readonly>
                    for Medical/Financial Assistance purposes of <input class="field-form" type="text" value="<?php echo $_GET['purpose']; ?>" readonly>.</p>
