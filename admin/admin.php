                    ...
                    <div class="carousel-inner">
                      <div class="carousel-item active">
                        ...
                        while ($row = $result->fetch_assoc()) {
                          if ($row['address'] == 'purok1') {
                            $counter1++;
                          } else if ($row['address'] == 'purok2') {
                            $counter2++;
                          } else if ($row['address'] == 'purok3') {
                            $counter3++;
                          } else if ($row['address'] == 'purok4') {
                            $counter4++;
                          } else if ($row['address'] == 'purok5') {
                            $counter5++;
                          }
                        }

                        /* ARRAY FOR PUROK RANKING ---------------------------------------------------------------*/
                        $purok_ranking = array(
                          "Purok 1" => $counter1,
                          "Purok 2" => $counter2,
                          "Purok 3" => $counter3,
                        ...
                        /* ARRAY FOR PUROK RANKING WITH KEY AND VALUE ---------------------------------------------------------------*/
                        $purok_ranking_key = array();
                        $purok_ranking_value = array();
                        foreach ($purok_ranking as $purok_key => $purok_value) {
                          $purok_ranking_key[] = $purok_key;
                          $purok_ranking_value[] = $purok_value;
                        }
                        ?>
                        <canvas class="col-10 mt-5" id="purokchart" style="margin:auto;"></canvas>
                      </div>
                                ...
                                ?>
                                  <tr>
                                    ...
                                    <td>
                                      ...
                                      <button type="button" class="btn btn-info updatebtnPurokRanking mb-1" style="width:4.5rem;">Edit</button>
                                      <a href="admin.php?deletePurokRanking=<?php echo $row['id']; ?>" class="btn btn-danger" style="width:4.5rem;">Delete</a>
